...
| **F5** | signal | **Undeclared inference** — a guess rendered as a fact | two edge kinds, one font | `tests` (declared, from a marker) and `implements` (name-matched) look identical. `[M]` **85 of 13084** `implements` edges declared at 2026-08-17 (0 of 14004 when this row was written) (⛔ the founding `1 : 10` was the pre-2026-08-17 definition — see the re-scope note above) |
